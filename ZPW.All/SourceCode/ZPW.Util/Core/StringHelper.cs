    ...
    public static partial class CoreHelper {
       ...
       public static  class StringHelper {
            ...
            public static string GenerateCode() {
                //return Encrypt.Md5By32(Guid.NewGuid().ToString()).ToLower();
                return string.Empty;
            }
            ...
            public static string GenerateCodeBy16() {
                //return Encrypt.Md5By16(Guid.NewGuid().ToString()).ToLower();
                return string.Empty;
            }
            ...
            private static string ResolvePinYinByFile(string text) {
                int index = ConstDefine.ChinesePinYin.IndexOf(text, StringComparison.Ordinal);
                if (index < 0)
                    return string.Empty;
                return ConstDefine.ChinesePinYin.Substring(index + 1, 1);
            }
            ...
            public static string Splice<T>(IEnumerable<T> list, string separator = ",", string quotes = "") {  
                var result = new StringBuilder();
            ...
            /// <param name="list">集合</param> 
            /// <param name="separator">分隔符，默认使用逗号分隔</param>
            public static string Splice<T>(IEnumerable<T> list, string separator = ",") {
            ...
            #region HasPattern(是否存在正则表达式的匹配成功项目)
            /// <summary>
            /// 是否存在正则表达式的匹配成功项目
            /// </summary>
