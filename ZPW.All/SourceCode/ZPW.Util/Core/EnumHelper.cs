...
namespace ZPW.Util.Core {
    ...
    public static partial class CoreHelper {
        ...
        public static class EnumHelper {
            ...
            /// <param name="member">成员名或值，范例：Enum1枚举有成员A=0，则传入“A”或“0”，则返回Enum1.A</param>
            /// <returns>范例：Enum1枚举有成员A=0，则传入“A”或“0”，则返回Enum1.A</returns>
            public static T GetInstance<T>(object member) {
                string value = member.ToStr();
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentNullException("member");
                return (T)Enum.Parse(typeof(T).GetType(), value, true);
            }
            ...
            public static string GetName<T>(object member) {
                return GetName(typeof(T).GetType(), member);
            }

            /// <summary>
            /// 获取成员名
            /// </summary>
            /// <param name="type">必须是枚举类型</param>
            ...
            public static int GetValue<T>(object member) {
                return GetValue(typeof(T).GetType(), member);
            }
            ...
            public static string GetDescription<T>(object member) {
                return ReflectionHelper.GetDescription<T>(GetName<T>(member));
            }
