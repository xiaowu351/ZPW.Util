...
namespace ZPW.Util.Core
{
	...
	public class WarningException : Exception
	{
		...
		public WarningException(string message, string code)
			: this(message, code, EnumLogLevel.Warning)
		{
		}
		...
		public WarningException(string message, string code, EnumLogLevel level)
		...
		public WarningException(Exception exception)
			: this("", "", EnumLogLevel.Warning, exception)
		{
		}
		...
		/// <param name="code">错误码</param>
		/// <param name="exception">异常</param>
		public WarningException(string message, string code, Exception exception)
			: this(message, code, EnumLogLevel.Warning, exception)
		{
		}
		...
		/// <param name="level">日志级别</param>
		/// <param name="exception">异常</param>
		public WarningException(string message, string code, EnumLogLevel level, Exception exception)
