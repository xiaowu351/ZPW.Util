...
namespace ShellLib
{
    ...
    public class ShellFileOperation
    {
        ...
        public enum ShellFileOperationFlags
        {
            ...
            FOF_NOCONFIRMATION = 0x0010,	// Respond with "Yes to All" for any dialog box that is displayed. 是否弹出确认对话框
            ...
            FOF_ALLOWUNDO = 0x0040,	// Preserve Undo information, if possible. If pFrom does not 放入回收站
            ...
            FOF_NOERRORUI = 0x0400,	// Do not display a user interface if an error occurs. 不提示错误UI
        ...
        public ShellFileOperation()
        {
            ...
            OperationFlags = ShellFileOperationFlags.FOF_ALLOWUNDO
			    ...
			    | ShellFileOperationFlags.FOF_NOCONFIRMATION ;
            ProgressTitle = "";
