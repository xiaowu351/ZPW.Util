...
namespace Wintellect.PowerCollections.Tests {
	...
	public class RedBlackTreeTests
	{
        ...
        /// <summary>
		/// TestMethod creation of the tree.
		/// </summary>
		...
		/// <summary>
		/// Insert values into tree to TestMethod the basic insertion algorithm. Validate
        ...
        /// <summary>
        /// TestMethod find with the replace option..
        /// </summary>
        [TestMethod]
		...
		/// <summary>
		/// TestMethod that deleting a non-present value works right.  A bug was found where the root isn't
		...
		/// <summary>
		/// Insert values into tree and enumerate then to TestMethod enumeration.
		/// </summary>
		[TestMethod]
