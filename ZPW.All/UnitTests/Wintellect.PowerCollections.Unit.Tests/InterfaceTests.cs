...
namespace Wintellect.PowerCollections.Tests {
	...
	internal static class InterfaceTests
	{
       ...
       /// <summary>
       /// TestMethod an IEnumerable should contain the given values in order
       /// </summary>
       ...
       /// <summary>
       /// TestMethod an IEnumerable should contain the given values in any order
       /// </summary>
       ...
       /// <summary>
       ///  TestMethod an ICollection that should contain the given values, possibly in order.
		/// </summary>
		/// <param name="coll">ICollection to TestMethod. </param>
        ...
        /// /// <summary>
		///  TestMethod an ICollection&lt;string&gt; that should contain the given values, possibly in order. Checks only the following items:
        ...
        /// <param name="equals">Predicate to TestMethod for equality; null for default.</param>
        ...
        /// <summary>
		///  TestMethod a readonly ICollection&lt;string&gt; that should contain the given values, possibly in order. Checks only the following items:
		///     GetEnumerator, CopyTo, Count, Contains, IsReadOnly
		/// </summary>
		/// <param name="coll">ICollection&lt;T&gt; to TestMethod. </param>
		/// <param name="valueArray">The values that should be in the collection.</param>
        ...
        /// <summary>
        ///  TestMethod a read-write ICollection&lt;string&gt; that should contain the given values, possibly in order. Destroys the collection in the process.
        /// </summary>
        /// <param name="coll">ICollection to TestMethod. </param>
        /// <param name="valueArray">The values that should be in the collection.</param>
        /// <param name="mustBeInOrder">Must the values be in order?</param>
        ...
        /// <summary>
        /// TestMethod an IDictionary that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary to TestMethod</param>
        ...
        /// <summary>
        /// TestMethod an read-only IDictionary that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary to TestMethod</param>
        ...
        /// <summary>
        /// TestMethod an read-write IDictionary that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary to TestMethod</param>
        ...
        /// <summary>
        /// TestMethod an generic IDictionary&lt;K,V&gt; that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary&lt;K,V&gt; to TestMethod</param>
        /// <param name="keys">key values for the dictionary</param>
        /// <param name="values">values for the dictionary</param>
        /// <param name="nonKey">A TKey that isn't in the dictionary</param>
        /// <param name="mustBeInOrder">True if the entries must be in order.</param>
        ...
        /// <summary>
        /// TestMethod an read-only IDictionary&lt;K,V&gt; that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary&lt;K,V&gt; to TestMethod</param>
        ...
        /// <summary>
        /// TestMethod an read-write IDictionary&lt;K,V&gt; that should contains the given keys and values, possibly in order.
        /// </summary>
        /// <typeparam name="TKey">Type of the keys</typeparam>
        /// <typeparam name="TValue">Type of the values</typeparam>
        /// <param name="dict">IDictionary&lt;K,V&gt; to TestMethod</param>
        ...
        /// <summary>
        /// TestMethod read-only IList&lt;T&gt; that should contain the given values, possibly in order. Does not change
        /// the list. Does not force the list to be read-only.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="coll">IList&lt;T&gt; to TestMethod. </param>
        ...
        /// <summary>
        /// TestMethod read-only non-generic IList that should contain the given values, possibly in order. Does not change
        /// the list. Does not force the list to be read-only.
        /// </summary>
        /// <param name="coll">IList to TestMethod. </param>
        /// <param name="valueArray">The values that should be in the list.</param>
        ...
        /// <summary>
        ///  TestMethod a read-write IList&lt;T&gt; that should contain the given values, possibly in order. Destroys the collection in the process.
        /// </summary>
        /// <param name="coll">IList&lt;T&gt; to TestMethod. </param>
        /// <param name="valueArray">The values that should be in the list.</param>
        ...
        /// <summary>
        ///  TestMethod a read-write non-generic IList that should contain the given values, possibly in order. Destroys the collection in the process.
        /// </summary>
        /// <param name="coll">IList to TestMethod. </param>
        /// <param name="valueArray">The values that should be in the list.</param>
