...
namespace Wintellect.PowerCollections.Tests
{
	...
	public class OrderedDictionaryTests
	{
        ...
        /// <summary>
        /// TestMethod adding keys/values to the collection. Make sure the return value is right, and that
        ...
        /// <summary>
        /// TestMethod adding keys/values to the collection. Like the Add() TestMethod, but uses the indexer dict operation.
		...
		/// <summary>
		/// TestMethod removing items from the tree.
		///</summary>
		[TestMethod]
		public void Remove()
		{
        ...
        /// <summary>
		/// TestMethod clearing the dictionary.
		/// </summary>
		[TestMethod]
		public void Clear()
		{
		...
		/// <summary>
		/// TestMethod ContainsKey. Make sure it returns the right valuesl. 
		/// </summary>
		[TestMethod]
        ...
        // TestMethod that it looks like a non-generic ICollection of DictionaryEntrys.
        [TestMethod]
